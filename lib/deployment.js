...
class Deployment {
  ...
  constructor(params) {
    ...
    let account = params.account || settings.defaultWallet
    ...
    this.walletAddress = config.user.getWalletRecord(this.network, account).address
    this.walletPath = config.user.getWalletRecord(this.network, account).filePath
