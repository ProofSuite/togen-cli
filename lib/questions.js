...
const categories = {
  ...
  choices: ['Configure Contracts', 'Configure Account', 'Display Contract Configuration', 'Build Contracts', 'Compile Contracts', 'Help', 'Close']
}
...
const accountConfigurationMenu = ({additionalFields = []}) => {
  let choices = ['Create new ethereum wallet', 'List ethereum wallets', 'Expose ethereum wallet private keys']
  choices = choices.concat(additionalFields)
