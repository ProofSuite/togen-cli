...
class Togen {
  ...
  constructor() {
    ...
    this.router = new Router({ mainMenu: this.Interface })
    this.settingsMenu = new SettingsMenu({router: this.router})
    this.accountsMenu = new AccountMenu({router: this.router})
    this.deployerMenu = new DeployerMenu({router: this.router})
  }
